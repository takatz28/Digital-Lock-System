...
## JA Pmod - Bank 13
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {ssd_out[0]}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {ssd_out[1]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {ssd_out[2]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {ssd_out[3]}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {kypd_pin7_io}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {kypd_pin8_io}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {kypd_pin9_io}];  # "JA9"


## ----------------------------------------------------------------------------
## JB Pmod - Bank 13
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {ssd_out[4]}];  # "JB1"
#set_property PACKAGE_PIN V8 [get_ports {ssd_out[5]}];  # "JB10"
set_property PACKAGE_PIN W11 [get_ports {ssd_out[5]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {ssd_out[6]}];  # "JB3"
set_property PACKAGE_PIN W8 [get_ports {ssd_out[7]}];  # "JB4"
...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN AB6 [get_ports {kypd_out_pin2_io}];  # "JC1_N"
set_property PACKAGE_PIN AB7 [get_ports {kypd_out_pin1_io}];  # "JC1_P"
set_property PACKAGE_PIN AA4 [get_ports {kypd_out_pin4_io}];  # "JC2_N"
set_property PACKAGE_PIN Y4  [get_ports {kypd_out_pin3_io}];  # "JC2_P"
set_property PACKAGE_PIN T6  [get_ports {kypd_out_pin8_io}];  # "JC3_N"
set_property PACKAGE_PIN R6  [get_ports {kypd_out_pin7_io}];  # "JC3_P"
set_property PACKAGE_PIN U4  [get_ports {kypd_out_pin10_io}];  # "JC4_N"
set_property PACKAGE_PIN T4  [get_ports {kypd_out_pin9_io}];  # "JC4_P"
